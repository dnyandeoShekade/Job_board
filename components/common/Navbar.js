    ...
    <header className="w-full bg-[#F2F5FF] border-b border-gray-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="hidden lg:flex items-center gap-3">
          <button className="px-5 py-2 text-sm font-medium text-indigo-600 border border-indigo-600 rounded-lg hover:bg-indigo-50 transition">
            Login
          </button>

          <button className="px-5 py-2 text-sm font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition">
            Sign Up
          </button>
        </div>
      ...
      >
        <div className="px-6 pb-6 border-t bg-[#F2F5FF]">
          ...
          <div className="flex flex-col gap-3 mt-6">
            <button className="w-full py-2 border rounded-lg bg-white hover:bg-gray-100">
              Login
            </button>

            <button className="w-full py-2 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700">
              Sign Up
            </button>
          </div>
        </div>
